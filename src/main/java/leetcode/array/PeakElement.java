 ...
 * any one of the peaks is fine. You may imagine that num[-1] = num[n] = -∞. For
 * example, in array [1, 2, 3, 1], 3 is a peak element and your function should
 * return the index number 2.
 * 
 * https://discuss.leetcode.com/topic/48268/share-my-java-solution-with-detailed
 * -explanation-binary-search/2
 */
