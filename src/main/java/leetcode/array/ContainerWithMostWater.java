...
public class ContainerWithMostWater {
    ...
    // Initially we consider the area constituting the exterior most lines. Now
    // to maximize the area,
    // we need to consider the area between the lines of larger lengths. If we
    ...
    // But moving the shorter line's pointer could turn out to be beneficial, as
    // per the same argument, despite the
    // reduction in the width. This is done since a relatively longer line
    // obtained by moving the shorter line's pointer
