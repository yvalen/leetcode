...
public class Sum {
     ...
     * Yahoo, Dropbox, Bloomberg, Yelp, Adobe 
     * Difficulty: easy 
     * Similar Questions: 15(3sum), 18(4sum), 167(Two Sum II, sorted input array),
     ...
     * Difficulty: medium 
     * Similar Questions: 1(2sum), 16(3sumclosest), 18(4sum), 259(ThreeSumSmaller)
     */
     ...
     * Company: Uber
     * Difficulty: Medium
     * Similar Questions: 1(2sum), 15(3sum), 454(4sum II)
     */
