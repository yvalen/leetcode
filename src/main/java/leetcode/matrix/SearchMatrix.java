...
public class SearchMatrix {
     ...
     * following matrix: [ [1, 3, 5, 7], [10, 11, 16, 20], [23, 30, 34, 50] ]
     ...
     * sorted in ascending from top to bottom. For example, consider the
     * following matrix: [ [1, 4, 7, 11, 15], [2, 5, 8, 12, 19], [3, 6, 9, 16,
     * 22], [10, 13, 14, 17, 24], [18, 21, 23, 26, 30] ] Given target = 5,
     * return true. Given target = 20, return false.
     */
