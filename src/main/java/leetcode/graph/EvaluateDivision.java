...
public class EvaluateDivision {
	...
	private double dfs(String start, String end, Map<String, List<String>> graph, Map<String, List<Double>> valueMap, Set<String> visited, double value) {
		if (visited.contains(start)) return 0.0;  // visited
