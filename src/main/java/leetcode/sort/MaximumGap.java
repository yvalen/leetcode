...
public class MaximumGap {
	 ...
	 * - Hence the i​th​​ bucket would hold the range of values: [min+(i−1)∗b, min+i∗b) (1-based indexing).
	 * - The index of the bucket to which a particular element belongs is given by (num−min)/b (0-based indexing) where num is the element in question.
	...
	public int maximumGap_withBucketSort(int[] nums) {
        ...
        int bucketSize = Integer.max(1,  (max-min)/(n-1)); // n-1 gaps between n elements 
