...
public class MeetingRoom {
	...
	public int minMeetingRooms(Interval[] intervals) {
		...
		// whenever there is a start meeting, we need to add one room. But before adding rooms, we check to see 
		// if any previous meeting ends, which is why we check start with the first end. When the start is bigger 
		// than end, it means at this time one of the previous meeting ends, and it can take and reuse that room. 
