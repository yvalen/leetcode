...
/*
 * LEETCODE 642
 * Design a search auto-complete system for a search engine. Users may input a sentence 
 ...
 * only be lower-case letters ('a' to 'z'), blank space (' ') or a special character ('#'). Also, the previously 
 ...
 * Explanation: There are four sentences that have prefix "i". Among them, "ironman" and "i love leetcode" have same 
 * hot degree. Since ' ' has ASCII code 32 and 'r' has ASCII code 114, "i love leetcode" should be in front of "ironman". 
 ...
 * Explanation: The user finished the input, the sentence "i a" should be saved as a historical sentence in system. 
 ...
 * are persisted across multiple test cases. 
 * 
