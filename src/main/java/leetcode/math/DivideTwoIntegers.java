...
public class DivideTwoIntegers {
    public int divide(int dividend, int divisor) {
        ...
        // divisor = 0;
        // dividend = INT_MIN and divisor = -1 (because abs(INT_MIN) = INT_MAX +
        // 1).
        ...
        // convert into long since dividend and divisor could be
        // Integer.MIN_VALUE
    ...
    private long divide_helper(long dividendLong, long divisorLong) {
        ...
        // whereas we are moving with stride 1, 2, 4, 8, 16...2^n for
        // performance reason.
        ...
        // Look for additional value for the multiple from the reminder
        // (dividend - sum) recursively.
