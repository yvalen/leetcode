...
public class FindMinimumInRotatedSortedArray {
    /*
     * LEETCODE 153 Suppose a sorted array is rotated at some pivot unknown to
     ...
     * 
     * Company: Microsoft Difficulty: medium Similar Questions:
     * 33(SearchInRotatedSortedArray), 154(Find Minimum in Rotated Sorted Array
     * II)
     */
    ...
    public int findMin(int[] nums) {
        ...
        // if the sorted array is not rotated, then nums[lo] < nums[hi] and we
        // can return nums[lo] immediately
    ...
    /*
     * LEETCODE 154 Follow up for "Find Minimum in Rotated Sorted Array": What
     * if duplicates are allowed? Would this affect the run-time complexity? How
     * and why?
     * 
     * Difficulty: hard Similar Questions: 153(Find Minimum in Rotated Sorted
     * Array)
     */
