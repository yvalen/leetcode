...
/**
 * LEETCODE 257 Given a binary tree, return all root-to-leaf paths. For example,
 * given the following binary tree: 1 / \ 2 3 \ 5 All root-to-leaf paths are:
 * ["1->3->5", "1->2"]
 * 
 * Company: Google, Facebook, Apple Difficulty: easy Similar Questions: 113(Path
 * Sum II)
 */
