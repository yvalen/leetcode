...
public class LongestConsecutiveSequence {
    /*
     * LEETCODE 298 Given a binary tree, find the length of the longest
     * consecutive sequence path. The path refers to any sequence of nodes from
     * some starting node to any node in the tree along the parent-child
     * connections. The longest consecutive path need to be from parent to child
     * (cannot be the reverse). For example, 1 \ 3 / \ 2 4 \ 5 Longest
     * consecutive sequence path is 3-4-5, so return 3. 2 \ 3 / 2 / 1 Longest
     * consecutive sequence path is 2-3,not 3-2-1 (since this is not an
    ...
    /*
     * LEETCODE 549 Given a binary tree, you need to find the length of Longest
     * Consecutive Path in Binary Tree. Especially, this path can be either
     ...
     * parent-child order. Example 1: Input: 1 / \ 2 3 Output: 2 Explanation:
     * The longest consecutive path is [1, 2] or [2, 1]. Example 2: Input: 2 / \
     * 1 3 Output: 3 Explanation: The longest consecutive path is [1, 2, 3] or
     * [3, 2, 1]. Note: All the values of tree nodes are in the range of [-1e7,
     * 1e7].
     * 
     * Company: Google Difficulty: medium
     */
