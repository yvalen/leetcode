...
public class InOrderSuccessorInBST {
	// Inorder successor of p is  either p's parent or the left most node in 's right sub tree
	...
	public TreeNode inorderSuccessor(TreeNode root, TreeNode p) {
		...
		if (root.val <= p.val) {
			...
			TreeNode left = inorderSuccessor(root.left, p); // this call returns null if p doesn't have right subtree or the left most node in p's right subtree
