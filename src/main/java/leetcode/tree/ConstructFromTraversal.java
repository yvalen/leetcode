...
public class ConstructFromTraversal {
	...
	private TreeNode buildTree_preorderInOrder_helper(int[] preorder, int preStart, 
        ...
        root.right = buildTree_preorderInOrder_helper(preorder, preStart+rootIdx-inStart+1, inorder, rootIdx+1, inEnd, inorderMap);
	...
	private TreeNode buildTree_postorderInOrder_helper(int[] inorder, int inStart, int inEnd, 
			int[] postorder, int postStart, int postEnd, Map<Integer, Integer> inorderMap) {
        ...
        root.left = buildTree_postorderInOrder_helper(inorder, inStart, rootIdx -1, 
        		postorder, postStart, postEnd-numsInRight-1, inorderMap);
        root.right = buildTree_postorderInOrder_helper(inorder, rootIdx+1, inEnd, 
        		postorder, postEnd-numsInRight, postEnd-1, inorderMap);
