 ...
 * to partition the tree to two trees which have the equal sum of values after 
 ...
 *    2   20
 * Output: False
 * Explanation: You can't split the tree into two trees with equal sum after removing 
 * exactly one edge on the tree.
 * Note:
...
public class EqualTreePartition {
	...
	// check if the hash table contains sum/2.
