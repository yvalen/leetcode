...
/*
 * Given the running logs of n functions that are executed in a non-preemptive single threaded CPU, 
 ...
 * function_id:start_or_end:timestamp. For example, "0:start:0" means function 0 starts from the very 
 * beginning of time 0. "0:end:0" means function 0 ends to the very end of time 0. Exclusive time of 
 * a function is defined as the time spent within this function, the time spent by calling other functions 
 * should not be considered as this function's exclusive time. You should return the exclusive time of 
 ...
 * Function 0 is running again at time 6, and also end at the time 6, thus executes 1 unit of time. So function 
 * 0 totally execute 2 + 1 = 3 units of time, and function 1 totally execute 4 units of time.
 * Note:
    ...
    public int[] exclusiveTime(int n, List<String> logs) {
        ...
        for (String log : logs) {
            ...
            if (ary[1].equals("start")) {
                ...
                result[stack.pop()]++;
                // need to increment prev here as the next interval starts after current end
                prev++; 
            }
        }
        return result;
