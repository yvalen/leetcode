 ...
 * Provide a number which is not assigned to anyone. - check: Check if a number
 * is available or not. - release: Recycle or release a number. Example: // Init
 * a phone directory containing a total of 3 numbers: 0, 1, and 2.
