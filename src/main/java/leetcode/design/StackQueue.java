 ...
 * queue. peek() -- Get the front element. empty() -- Return whether the queue
 * is empty. Notes: You must use only standard operations of a stack -- which
 ...
 * may simulate a stack by using a list or deque (double-ended queue), as long
