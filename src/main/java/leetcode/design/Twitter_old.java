...
public class Twitter_old {
    ...
    public void follow(int followerId, int followeeId) {
        ...
        /*
         * if (followers.add(followerId)) { Set<Integer> tweets =
         * tweetsMap.get(followeeId); if (tweets != null) { List<Integer> feeds
         * = feedsMap.get(followerId); if (feeds == null) { feeds = new
         * ArrayList<>(); feedsMap.put(followerId, feeds); }
         * feeds.addAll(tweets); } }
         */
    }
    ...
    public void unfollow(int followerId, int followeeId) {
        ...
        /*
         * Set<Integer> tweets = tweetsMap.get(followeeId); if (feeds != null &&
         * tweets != null) { List<Integer> updatedFeeds =
         * feeds.stream().filter(id ->
         * !tweets.contains(id)).collect(Collectors.toList());
         * feedsMap.put(followerId, updatedFeeds); }
         */
    }

    public static void main(String[] args) {
        Twitter_old twitter = new Twitter_old();
