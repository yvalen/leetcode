 ...
 * draw a vertical line from the top to the bottom and cross the least bricks. The 
 * brick wall is represented by a list of rows. Each row is a list of integers 
 * representing the width of each brick in this row from left to right. If your line 
 * go through the edge of a brick, then the brick is not considered as crossed. 
