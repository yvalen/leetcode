 ...
 * 
 * Company: Uber, Apple, Snapchat
 * Difficulty: medium
 * Similar Questions: 37(SolveSudoku)
 */
    ...
    public boolean isValidSudoku_withSet(char[][] board) {
        ...
        for (int i = 0; i < board.length; i++) {
            ...
            for (int j = 0; j < board[0].length; j++) {
                ...
                // 0,0, 0,1, 0,2; < --- 3 Horizontal Steps followed by
                // 1 Vertical step to next level.
                // 1,0, 1,1, 1,2; < --- 3 Horizontal Steps followed by
                // 1 Vertical step to next level.
                ...
                // i.e. 0,0 is start of first block, second block is 0,3 (not 0,1);
