 ...
 * employee 3. They have importance value 15, 10 and 5, respectively. 
 * Then employee 1 has a data structure like [1, 15, [2]], and employee 2 has [2, 10, [3]], 
 * and employee 3 has [3, 5, []]. Note that although employee 3 is also a subordinate of 
 ...
 * Output: 11
 * Explanation: Employee 1 has importance value 5, and he has two direct subordinates: employee 2 
 * and employee 3. They both have importance value 3. So the total importance value of employee 1 
 * is 5 + 3 + 3 = 11.
 * Note:
