 ...
 * 
 * Company: Microsoft, Amazon, Bloomberg, Airbnb
 * Difficulty: easy
 * Similar Questions: 
 *
...
public class IntersectionOfTwoLinkedList {
	...
	// We can use two iterations. In the first iteration, we will reset the pointer of one linked list 
	// to the head of another after it reaches the tail node. In the second iteration, we will move two 
	// pointers until they points to the same node. Our operations in first iteration will help us counteract 
	// the difference. So if two linked list intersects, the meeting point in second iteration must be the 
