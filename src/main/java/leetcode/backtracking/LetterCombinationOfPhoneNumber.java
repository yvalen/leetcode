...
public class LetterCombinationOfPhoneNumber {
    ...
    // outer loop execute n times, in each iteration we access the front
    // elements in the queue with length of i
    // (worst case would be n). This makes it O(n^2). Inner loop runs k time,
    // O(k*n^2)
