...
public class PermutationSequence {
	...
	// For n numbers, permutations can be divided into n groups with (n - 1)! elements in each group. 
	// Thus, k / (n - 1)! is the group index among the current n (to be) sorted groups, and k % (n - 1)! 
	...
	public String getPermutation_withFactorial(int n, int k) {
        ...
        for (int i = n; i > 0; i--) {
            ...
            nums.remove(index); // need to remove the number used already from list
        }
        return sb.toString();
		/*
