...
public class PalindromePartitioning {
     ...
     * is a palindrome. Return all possible palindrome partitioning of s. For
    ...
    public List<List<String>> partition_iterativeDP(String s) {
        ...
        // dp[left,right] = true if right-left<=1 or s[left] == s[right] &&
        // dp[left+1,right-1]
        ...
        // add it to each solution for subproblem of the matching prefix, else
        // skip it.
        // result[0..right] = result[0..left-1] + s[left..right] if
