 ...
 * predict whether player 1 is the winner. You can assume each player plays to 
 * maximize his score.
 * Example 1: Input: [1, 5, 2] Output: False
 * Explanation: Initially, player 1 can choose between 1 and 2. If he chooses 2 (or 1), 
 * then player 2 can choose from 1 (or 2) and 5. 
 * If player 2 chooses 5, then player 1 will be left with 1 (or 2). So, final score of 
 * player 1 is 1 + 2 = 3, and player 2 is 5. Hence, player 1 will never be the winner 
 ...
 * No matter which number player 2 choose, player 1 can choose 233. Finally, player 1 has 
 * more score (234) than player 2 (12), so you need to return True representing player1 can win.
 * Note:
...
public class PredictWinner {
    public boolean PredictTheWinner_2d(int[] nums) {
        if (nums == null || nums.length == 0)
            return true;
        int n = nums.length - 1;
        // dp[i][j] stores how much more score player1 gets than player2 from i to j
