 ...
 * Every time you guess wrong, I'll tell you whether the number I picked is higher or lower. However, when you guess a particular 
...
public class GuessNumberHigherOrLowerII {
	 ...
	 * For any k between start and end, the worst cost for this is: k+max(DP( start, k-1 ), DP(k+1, end )). The goal is minimize the cost, 
