...
public class MaxSumOfThreeNonOverlappingSubArrays {
    ...
    // [i+1, n-1]
    // we can test every possible index of middle interval [k, n-2k], and get
    // the corresponding
    ...
    public int[] maxSumOfThreeSubarrays(int[] nums, int k) {
        ...
        // caution: the condition is ">= maxRight" for right interval, and ">
        // maxLeft" for left interval
        // this will always select the left most interval when two intervals
        // have the same sum
