...
public class DecodeWays {
     ...
     * Difficulty: medium
     * Similar Questions: 639(Decode Ways II)
     */
     ...
     * the total number of way to decode it. Also, since the answer may be very 
     * large, you should return the output mod 10^9 + 7. 
     * Example 1: 
     * Input: "*" Output: 9 
     ...
     * Company: Facebook 
     * Difficulty: hard
     * Similar Questions: 91(Decode Ways)
     */
    public int numDecodingsII(String s) {
        ...
        if (s.length() == 1) return (int) w1;
        long w2 = ways(s.charAt(0), s.charAt(1)) + ways(s.charAt(1))*w1;
