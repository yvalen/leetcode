 ...
 * does not represent a decimal point and is used to separate number sequences. For instance, 
 * 2.5 is not "two and a half" or "half way to version three", it is the fifth second-level 
...
public class CompareVersionNumber {
    ...
    public int compareVersion(String version1, String version2) {
        ...
        while (start1 < len1 || start2 < len2) {
            ...
            int v1 = (start1 >= len1) ? 0 : Integer.parseInt(version1.substring(start1, end1)); // fill
                                                                                                // 0
                                                                                                // if
                                                                                                // reaches
                                                                                                // end
    ...
    public int compareVersion_withSplit(String version1, String version2) {
        ...
        String[] ary1 = version1.split("\\."); // need to escape . since . in
