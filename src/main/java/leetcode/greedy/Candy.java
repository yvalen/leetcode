...
public class Candy {
    ...
    public int candy_bruteForce(int[] ratings) {
        ...
        while (continueGiving) {
            ...
            // scan rating array from left to right and check element with its
            // neighbor
            for (int i = 0; i < n; i++) {
    ...
    public int candy_twoArray(int[] ratings) {
        ...
        int[] left2right = new int[n]; // store the number of candies required
                                       // taking care of distribution relative
                                       // to the left neighbor only
        ...
        int[] right2left = new int[n]; // store the number of candies required
                                       // taking care of distribution relative
                                       // to the right neighbor only
    ...
    public int candy_constantSpace(int[] ratings) {
        ...
        int sum = 0;
        int up = 0, down = 0; // keeps track of the number of elements on the
        ...
        for (int i = 1; i < n; i++) {
            ...
            // update count at the end of the falling slope following a rising
            // slope
